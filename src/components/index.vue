<template lang="html">
    ...
    <div class="window" @mouseover="stop" @mouseleave="play">
      ...
      <ul class="direction">
        <li class="left" @click="move(1080, 1, speed)">
        ...
        <li class="right" @click="move(1080, -1, speed)">
	...
	<!-----------主导航nav-top---------------->		
			<div class="nav-top">
				<div class="nav-top-1">
					...
					<ul class="nav-top-2">
						...
						<li><a href="javascript:void(0)">一日游</a></li>
					</ul>
					...
					<ul class="nav-top-2">
						...
						<li><a href="javascript:void(0)">客栈</a></li>
					</ul>
					...
					<ul class="nav-top-2">
						...
						<li><a href="javascript:void(0)">政府投诉</a></li>
					</ul>	
				</div>
			</div>
		<div class="nav-top-3" ><!--灰色背景-->
			<div class="nav-top-4" >
				<img src="../img/1.png" />
			</div>
		...
		<div class="foot">
			...
			<ul class="foot-1">
				<li><img style="margin-top: 0px;padding: 0;margin-top: -5px;" src="../img/13.gif"/></li>
				<li>我</li>
			</ul>
		</div>
...
<script>
  ...
  methods:{
    ...
    move(offset, direction, speed) {
      ...
      direction === -1 ? this.currentIndex += offset/1080 : this.currentIndex -= offset/1080
    ...
    animate(des, direc, speed) {
      ...
      this.temp = window.setInterval(() => {
        if ((direc === -1 && des < this.distance) || (direc === 1 && des > this.distance)) {
          ...
          window.clearInterval(this.temp)
          this.distance = des
          if (des < -3000) this.distance = -1080
          if (des > -1080) this.distance = -3000
        }
      }, 20)
    },
    jump(index) {
      const direction = index - this.currentIndex >= 0 ? -1 : 1;
      const offset = Math.abs(index - this.currentIndex) * 1080;
